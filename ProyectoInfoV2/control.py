"""
El módulo Control realiza la integración del módulo de Lógica y de Interfaz. De forma adicional, implementa
 una herramienta de corrección de ingreso de datos para el usuario y evalúa la posibilidad de la irresolubilidad de un sistema de ecuaciones.
"""
import numpy as np
import pandas as pd
